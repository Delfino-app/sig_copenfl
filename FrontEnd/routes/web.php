...
Route::group([
    ...
    Route::get('/licencas/filtro/{estado}/{dataInicio?}/{dataFim?}', ['as' =>'licenca.filtro.get','uses' => 'LicencaController@filtro']);
    Route::post('/licencas/filtro/', ['as' =>'licenca.filtro.post','uses' => 'LicencaController@filtroPost']);
