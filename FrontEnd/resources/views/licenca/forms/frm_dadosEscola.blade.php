<div class="row">
	...
	<div class="form-group col-lg-4 col-sm-6">
		...
		<input type="number" name="escola_ano_inicio" placeholder="Ano de Início" data-parsley-group="step-4" data-parsley-required="true" class="form-control" />
	</div>
	<div class="form-group col-lg-4 col-sm-6">
		<label class="text-lg-right col-form-label">Ano de Término</label>
		<input type="number" name="escola_ano_termino" placeholder="Ano de Término" data-parsley-group="step-4" data-parsley-required="false" class="form-control" />
	</div>
	<div class="form-group col-lg-4 col-sm-6">
		<label class="text-lg-right col-form-label">Estado</label>
		<select class="form-control" name="escola_estado">
			<option value="0">Selecionar</option>
