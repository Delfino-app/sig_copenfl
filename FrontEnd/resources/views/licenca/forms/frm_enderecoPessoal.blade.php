	...
	<div class="col-lg-6" style="padding-rigth:15px">
		...
		<div class="content_address row">
			<div class="form-group col-lg-6 col-sm-12">
				...
				<select data-parsley-group="step-2" data-parsley-required="true" class="form-control" id="endereco_municipio" name="endereco_municipio">
			...
			<div class="form-group col-lg-6 col-sm-12">
				...
				<input type="number" name="endereco_casa" placeholder="Casa nº" data-parsley-group="step-2" data-parsley-required="false" class="form-control" />
			</div>
		</div>
	</div>
	<div class="col-lg-6" style="padding-left:15px">
		...
		<div class="content_address row">
			<div class="form-group col-lg-6 col-sm-12">
				...
				<input type="number" name="endereco_telefone" placeholder="Telefone" data-parsley-group="step-2" data-parsley-required="true" class="form-control" />
			</div>
			<div class="form-group col-lg-6 col-sm-12">
			...
			<div class="form-group col-lg-6 col-sm-12">
				...
				<input type="text" name="endereco_caixa_postal" placeholder="Caixa Postal" data-parsley-group="step-2" data-parsley-required="false" class="form-control" />
			</div>
			<div class="form-group col-lg-6 col-sm-12">
				<label class="text-lg-right col-form-label">Fax</label>
				<input type="text" name="endereco_fax" placeholder="Fax" data-parsley-group="step-2" data-parsley-required="false" class="form-control" />
			</div>		
		</div>
	</div>
</div>
