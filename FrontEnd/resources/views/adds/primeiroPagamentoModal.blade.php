<div class="modal fade" id="modalAddPrimeiroPagamento">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" style="color:#1c1c1c">Novo Pagamento</h4>
					...
					<div class="col-lg-12">
						<form class="row p-20" enctype='multipart/form-data' action="{{route('pagamento.post')}}" method="POST">
							...
							<div class="form-group col-lg-12 col-sm-6">
                                <hr>
								<button class="btn btn-primary" type="submit" style="width:100%;padding:10px;font-size:14px">
									Salvar <i class="fa fa-plus-circle"></i>
								</button>
							</div>
                            </div>
						</form>
