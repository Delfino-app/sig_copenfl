...
@section('conteudo')
	<div id="content" class="content content-form">
		<form action="{{route('licenca.nova')}}" method="POST" name="form-wizard" class="form-control-with-bg">
			{{ csrf_field() }}
			<!-- begin wizard -->
			<div id="wizard">
				<!-- begin wizard-step -->
				...
				<div>
					...
					<div id="step-5">
						<div class="jumbotron m-b-0 text-center">
							<h2 class="display-4" style="font-size:24px;font-weight:600">
								Concluir registro
							</h2>
							<p class="lead mb-4" style="font-size:16px;font-weight:500">
